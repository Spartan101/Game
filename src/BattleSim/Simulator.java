...
//private ArrayList<Enemy> enemies;
    ...
    public Simulator() {
        JOptionPane.showMessageDialog(null,"Running Simulation V1");
        spartan101 = new Player(10,12,10,4,9,5,9,5,1,2);
        JOptionPane.showMessageDialog(null,"Player created");
        grunt = new Enemy(20,2,2,2);
        //Enemy[] grunt = new Enemy[2];
        //enemies = new ArrayList<Enemy>();
        //enemies.add(grunt = new Enemy(20,2,2,2));
        //enemies.add(grunt = new Enemy(30,2,2,2));
